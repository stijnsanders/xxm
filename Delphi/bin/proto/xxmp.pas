...
type
  ...
  public
    ...
    function LoadFragment(Context: IXxmContext; Address: WideString): IXxmFragment; override;
...
function TXxm[[ProjectName]].LoadFragment(Context: IXxmContext; Address: WideString): IXxmFragment;
begin
  Result:=XxmFragmentRegistry.GetFragment(Self,Address,Context.ContextString(csLocalURL));
end;
