...
uses
  Windows, SysUtils, xxmHostMain, Classes;
...
type
  ...
  private
    ...
    FQueue:TXxmHostedContext;
    procedure SetSize(x:integer);
  public
    constructor Create;
    destructor Destroy; override;
    procedure Queue(Context:TXxmHostedContext);//called from handler
    function Unqueue:TXxmHostedContext;//called from threads
  end;
...
procedure TXxmPageLoaderPool.Queue(Context:TXxmHostedContext);
var
  c:TXxmHostedContext;
  i:integer;
begin
...
function TXxmPageLoaderPool.Unqueue:TXxmHostedContext;
begin
